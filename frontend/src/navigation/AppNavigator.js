        ...
        >
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <View style={{ alignItems: 'center', justifyContent: 'center', top: 10 }}>
                            <Ionicons name={focused ? "map" : "map-outline"} size={25} color={focused ? COLORS.primary : "#748c94"} />
                        </View>
                    )
                }}
            />
            ...
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <View style={{ alignItems: 'center', justifyContent: 'center', top: 10 }}>
                            <Ionicons name={focused ? "people" : "people-outline"} size={25} color={focused ? COLORS.primary : "#748c94"} />
                        </View>
                    )
                }}
            />
...
function DrawerNav() {
    return (
        ...
        >
            <Drawer.Screen name="Home" component={MainTabs} options={{ title: 'Adventure Map' }} />
...
export default function AppNavigator() {
    return (
        <Stack.Navigator initialRouteName="Auth">
            ...
            <Stack.Screen name="MainBox" component={DrawerNav} options={{ headerShown: false }} />
            <Stack.Screen
                name="RecordModal"
